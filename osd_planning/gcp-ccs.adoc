...
* link:https://github.com/openshift/managed-cluster-config/blob/master/resources/wif/4.21/vanilla.yaml[Example Workload Identity Federation configuration for {product-title} on {GCP}]
