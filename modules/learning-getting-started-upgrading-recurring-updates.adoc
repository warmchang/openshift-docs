...
[role="_abstract"]
To schedule your cluster to automatically receive new patch (z-stream) updates, you can set your cluster to upgrade on a recurring basis within {cluster-manager}.
