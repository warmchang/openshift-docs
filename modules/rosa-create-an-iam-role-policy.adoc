...
[NOTE]
====
To use a CloudWatch group, you must create an IAM role and policy. To use an S3 bucket, you do not need an IAM role and policy. The only supported Amazon S3-managed encryption method is `SSE-S3`.
====
